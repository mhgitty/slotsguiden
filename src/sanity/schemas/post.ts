...
export const postType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'category', title: 'Category', type: 'reference', weak: true, to: [{ type: 'category' }], group: 'content' }),
    defineField({ name: 'author', title: 'Author', type: 'reference', weak: true, to: [{ type: 'author' }], group: 'content' }),
