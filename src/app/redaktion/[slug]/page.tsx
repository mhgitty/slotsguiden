...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: `${BASE}/redaktion/${slug}/` },
    openGraph: { title, description, url: `${BASE}/redaktion/${slug}/` },
  }
}
    ...
    '@graph': [
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 2, name: author.name, item: `${BASE}/redaktion/${slug}/` },
        ],
      },
    ],
  }
